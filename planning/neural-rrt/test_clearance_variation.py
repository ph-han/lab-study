...
if __name__ == "__main__":
    ...
    for clr in tqdm([1, 2, 4, 6], desc="Testing clearance..."):
        ...
        for seed in tqdm(seeds, desc="Testing..."):
            ...
            # --- Neural RRT* ---
            neural_planner = NeuralRRTStar(42, clr, 2, 7000, map_path,
                                           is_neural_mode=True, expand_size=2)
            ...
            # --- RRT* ---
            set_seed(1000 + seed)
            rrt_planner = NeuralRRTStar(42, clr, 2, 7000, map_path,
                                        is_neural_mode=False, expand_size=2)
        ...
        fig.suptitle(f"Comparison at Clearance={clr}", fontsize=14)
