...
class Car:
    ...
    def show(self):
        ...
        car = np.array([
            [-self.REAR_OVERHANG, -self.REAR_OVERHANG, self.WHEEL_BASE + self.FRONT_OVERHANG, self.WHEEL_BASE + self.FRONT_OVERHANG, -self.REAR_OVERHANG],
        ...
        total_front_yaw = self.yaw + self.steer
        steer_rot = np.array([
            [cos(total_front_yaw), -sin(total_front_yaw)],
            [sin(total_front_yaw), cos(total_front_yaw)]
        ], dtype=np.float32)
